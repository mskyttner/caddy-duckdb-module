...
ARG SWAGGER_UI_VERSION=5.32.14
...
# - fts:         BM25 full-text search over VARCHAR columns (core extension) —
#                for keyword-search/autocomplete tools ahead of a Lance rebuild
